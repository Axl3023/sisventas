...
@section('content_header')
    ...
    <div class="lg:mx-20 my-4">
        ...
        <div class="flex justify-between items-center">
            <form action="{{ route('unidades.index') }}" method="GET" class="flex items-center">
                <input type="text" name="search" class="form-input px-4 py-2 h-full rounded-l-md"
                    placeholder="Buscar unidad" value="{{ request('search') }}">
...
@section('js')
    ...
    <script>
        function confirmDelete(id){
                alertify.confirm("¿Seguro que quieres eliminar la unidad?",
                function(){
